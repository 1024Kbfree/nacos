...
public final class ResourceSinkGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<istio.mcp.v1alpha1.Mcp.Resources,
      istio.mcp.v1alpha1.Mcp.RequestResources> getEstablishResourceStreamMethod;
  ...
  public static io.grpc.MethodDescriptor<istio.mcp.v1alpha1.Mcp.Resources,
      istio.mcp.v1alpha1.Mcp.RequestResources> getEstablishResourceStreamMethod() {
    io.grpc.MethodDescriptor<istio.mcp.v1alpha1.Mcp.Resources, istio.mcp.v1alpha1.Mcp.RequestResources> getEstablishResourceStreamMethod;
      ...
      synchronized (ResourceSinkGrpc.class) {
        if ((getEstablishResourceStreamMethod = ResourceSinkGrpc.getEstablishResourceStreamMethod) == null) {
          ResourceSinkGrpc.getEstablishResourceStreamMethod = getEstablishResourceStreamMethod =
              io.grpc.MethodDescriptor.<istio.mcp.v1alpha1.Mcp.Resources, istio.mcp.v1alpha1.Mcp.RequestResources>newBuilder()
  ...
  public static abstract class ResourceSinkImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public io.grpc.stub.StreamObserver<istio.mcp.v1alpha1.Mcp.Resources> establishResourceStream(
        io.grpc.stub.StreamObserver<istio.mcp.v1alpha1.Mcp.RequestResources> responseObserver) {
