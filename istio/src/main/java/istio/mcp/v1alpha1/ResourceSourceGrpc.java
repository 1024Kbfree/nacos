...
public final class ResourceSourceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<istio.mcp.v1alpha1.Mcp.RequestResources,
      istio.mcp.v1alpha1.Mcp.Resources> getEstablishResourceStreamMethod;
  ...
  public static io.grpc.MethodDescriptor<istio.mcp.v1alpha1.Mcp.RequestResources,
      istio.mcp.v1alpha1.Mcp.Resources> getEstablishResourceStreamMethod() {
    io.grpc.MethodDescriptor<istio.mcp.v1alpha1.Mcp.RequestResources, istio.mcp.v1alpha1.Mcp.Resources> getEstablishResourceStreamMethod;
      ...
      synchronized (ResourceSourceGrpc.class) {
        if ((getEstablishResourceStreamMethod = ResourceSourceGrpc.getEstablishResourceStreamMethod) == null) {
          ResourceSourceGrpc.getEstablishResourceStreamMethod = getEstablishResourceStreamMethod =
              io.grpc.MethodDescriptor.<istio.mcp.v1alpha1.Mcp.RequestResources, istio.mcp.v1alpha1.Mcp.Resources>newBuilder()
  ...
  public static abstract class ResourceSourceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public io.grpc.stub.StreamObserver<istio.mcp.v1alpha1.Mcp.RequestResources> establishResourceStream(
        io.grpc.stub.StreamObserver<istio.mcp.v1alpha1.Mcp.Resources> responseObserver) {
